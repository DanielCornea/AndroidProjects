...
public class dbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_BRUSHES_TABLE =  "CREATE TABLE " + BrushContract.BrushEntry.TABLE_NAME + " ("
                ...
                + BrushContract.BrushEntry.COLUMN_IMAGE_BLOB + " BLOB,"
                + BrushContract.BrushEntry.COLUMN_IMAGE_NAME + " TEXT, "
                + BrushContract.BrushEntry.COLUMN_PRICE + " INTEGER NOT NULL DEFAULT 0);";
